...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_app_testattempt_status'), 'app_testattempt', ['status'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_app_testattempt_status'), table_name='app_testattempt')
